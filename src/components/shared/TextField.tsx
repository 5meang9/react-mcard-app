import React, { FocusEventHandler, forwardRef, InputHTMLAttributes, useState } from "react";
...
const TextField = forwardRef<HTMLInputElement, TextFieldProps>(
  function TextField({label, hasError, helpMessage, onFocus, onBlur, ...props}, ref) {
    ...
    return <div>
      ...
      {helpMessage ? 
        <Text typography="t7" color={labelColor} display="inline-block" style={{marginTop: 6, fontSize: 12}}>
          {helpMessage}
        </Text> 
        : null
      }
