...
function AgreementTitle({children, checked, onChange}: {children: React.ReactNode; checked: boolean; onChange: (e: MouseEvent<HTMLElement>, checked: boolean) => void}){
  return(
...
function AgreementDescription({children, checked, onChange, link}: {children: React.ReactNode; checked: boolean; onChange: (e: MouseEvent<HTMLElement>, checked: boolean) => void; link?: string;}){
  return(
    <Flex as='li'>
